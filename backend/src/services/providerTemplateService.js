...
export const DEFAULT_TEMPLATES = [
  ...
  },
  {
    ...
    key_label: 'Google AI API Key',
    key_placeholder: 'AIza... hoặc key từ Google AI Studio',
  ...
  },
  {
    ...
    key_label: '9Router API Key',
    key_placeholder: 'Lấy từ dashboard 9Router',
    key_help: 'Model: cx/gpt-5.5-image (chữ thường, có prefix cx/). Endpoint VPS: https://api.tidien.xyz/v1/images/generations',
    sort_order: 8,
  },
];
