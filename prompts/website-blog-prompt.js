 ...
 *
 * Dùng: ghép PROJECT_CONTEXT (lấy từ DB dự án) + topic vào prompt này,
 * gửi cho Claude, nhận về bài viết hoàn chỉnh.
 */

function buildWebsiteBlogPrompt({ projectContext, topic, researchBrief }) {
  return `
...
module.exports = { buildWebsiteBlogPrompt };
